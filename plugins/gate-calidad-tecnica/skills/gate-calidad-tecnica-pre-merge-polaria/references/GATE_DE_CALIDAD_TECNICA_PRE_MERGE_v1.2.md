...
**Paso 3 — Revisión aislada.** El subagente recibe solo el diff y el contexto, aplica los 7 criterios (sección 6) y **corre las pruebas él mismo**. Devuelve una tabla con los 7 criterios y el Veredicto Final, que la skill muestra al dev sin cambios.

**Paso 4 — Veredicto.** La skill lo registra en `.git/polaria-gate/<commit>.md` (dentro de `.git/`, nunca se sube al repo):
